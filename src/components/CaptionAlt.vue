<template>
  <v-card
    class="d-flex flex-row mx-3 p-1 caption"
    :class="{ open, isUserEdit: !edit.panoptoGenerated }"
  >
    <v-row align="center" class="mx-1">
      ...
      <v-col cols="1" id="captionActions" justify="end">
        ...
        <v-btn tabindex="0" v-if="edit.isAuthor" title="Delete" icon small @click="report()">
...
.caption.isUserEdit {
  border-bottom: 2px solid #735f23;
  transition: 0.25s ease border-bottom;
}
.caption.isUserEdit:hover {
